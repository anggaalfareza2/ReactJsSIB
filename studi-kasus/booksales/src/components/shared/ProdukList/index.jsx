              ...
              <div className="card shadow-sm">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    Buku ini mengajarkan sistem praktis membangun kebiasaan baik
                    dan menghancurkan kebiasaan buruk secara bertahap.
                  </p>
            ...
            <div className="col">
              <div className="card shadow-sm">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Pemimpin hebat menginspirasi dengan memulai dari "Mengapa".
                    Buku ini menjelaskan bagaimana menemukan tujuan utama Anda
                    untuk memotivasi tim dan pelanggan.
                  </p>
                  <div className="d-flex justify-content-between align-items-center">
                    <div className="btn-group">
                      <button
              ...
              <div className="card shadow-sm">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    lebih dalam, produktif, dan menghasilkan karya berkualitas.
                  </p>
                  <div className="d-flex justify-content-between align-items-center">
                    <div className="btn-group">
                      <button
